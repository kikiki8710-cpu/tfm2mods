...
- ⬜**banpick_order 스텁 본문 재작성**(HL·SLOTSEL·DRAIN_HL·AITURN = 현재 **자동 스킵 중**·크래시 위험 없음·기능만 죽음. 재작성 자료 = §4d.3·§4e.2) · ~~comptest 바이트패치 19~~ → **✅17/17 재핀 완료(§4c.1)** · **ai_adjust 바이트패치 908·JT 베이스**(665건 매핑은 확보·§4c.2).
