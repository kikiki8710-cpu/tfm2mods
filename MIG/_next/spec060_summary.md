...
판정 분포: 동치 146 · ✅동치 38 · ⚠변경·한 줄 20 · ⚠변경·다건 16 · 심층 15 · 미발견 12 · 변경 9 · ❗대폭 6 · ⚠변경·부분규명 4 · exe 없음 2
...
| 7 | `ccc010` | `e60420` | sub_plan | 변경(mig060: 소폭) |  |
...
| 14 | `db90f0` | `faa440` | update | 변경(mig060: 소폭) |  |
...
| 19 | `d40b20` | `None` | best_jungle_goal | 미발견 |  |
...
| 35 | `e06df0` | `None` | resolve_fight_stake | 미발견 |  |
...
| 48 | `e0b730` | `None` | v25_scoped_battle_objective | 미발견 |  |
...
| 54 | `de0770` | `None` | TeamPlan::update | 미발견 |  |
...
| 58 | `db8ba0` | `fb9b70` | target_bush_v41 | 변경(mig060: 오프셋만 변경) |  |
...
| 65 | `de3d90` | `100b8d0` | check_epic_kill_time_with_hp | 변경(mig060: 오프셋만 변경) |  |
| 66 | `d40f10` | `fb1510` | evaluate_gank_opportunity_with_score | ⚠변경·한 줄(r20) | 한 줄 · 노이즈 폭 `k=(1000-judge)/10` → `/20` (헬퍼 de2fa0 · RNG 마스크 달라짐) |
| 67 | `dd6b40` | `f0dc20` | v24_objective_setup_lane_pressure_ready | 변경(mig060: 소폭) |  |
...
| 82 | `de92d0` | `fb5ff0` | epic_passive_plan | ❗대폭(티어1 이관)(r20) |  |
| 83 | `defcd0` | `fd7f70` | EpicHuntAndPokePlan::sub_plan | ⚠변경·부분규명(전담)(r20) | 전담 · ObjContest 반환 · hp 51→50(v3) · tp 게이트 다수 |
...
| 87 | `e6b800` | `d72e70` | check_kill | 심층(티어1) | 심층 · v3 확장 후보 e0f970 · escape_possible eeb5b0 · (c1,c2,c3) 특성 · v |
| 88 | `e4b070` | `None` | v2_apply_assign_commit | 미발견 |  |
...
| 91 | `d2e500` | `fa3980` | PassiveJunglePlan::sub_plan | ❗대폭(티어1 이관)(r20) |  |
...
| 96 | `d65620` | `1011d20` | serpen_passive_plan | ❗대폭(티어1 이관)(r20) |  |
| 97 | `df0e90` | `dcbe00` | SerpenHuntAndPokePlan::sub_plan | ❗대폭(티어1 이관)(r20) |  |
| 98 | `d9bce0` | `e87300` | steal::evaluate_steal_for_target | 동치(mig060_same 확정: 동일) |  |
| 99 | `d9ac10` | `e85f00` | steal::should_steal_now | 변경(mig060: 소폭) |  |
...
| 102 | `dfb840` | `dd8e70` | BattlePlan::update | 심층(티어1) |  |
| 103 | `d8ca70` | `ffdda0` | position_risk_all_zero_near | 동치(mig060_same 확정: 동일) |  |
| 104 | `e59b20` | `d5b980` | handle_chat_inner | 심층(티어1) |  |
| 105 | `e46bc0` | `d38180` | passive_plan | 심층(티어1) |  |
| 106 | `dd26e0` | `f09860` | TeamPlan::v25_objective_posture | ✅동치(+필드/게이트/텔레메트리)(r20) |  |
| 107 | `dcee40` | `f024d0` | TeamPlan::handle_none_or_gank_objective | 심층(티어1) |  |
| 108 | `dda220` | `f10f70` | TeamPlan::update_objective_after_steal | 심층(티어1) |  |
| 109 | `df36e0` | `dcce40` | BattlePlan::update_v32 | 심층(티어1) |  |
| 110 | `e5d5d0` | `d606b0` | LegacyPlanHandler::handle_interact_battl | 심층(티어1) |  |
| 111 | `e4c5c0` | `d3d210` | LegacyPlanHandler::update | 심층(티어1) |  |
...
| 155 | `db8e60` | `None` | LineGankerPlan::make_gank_battle | 미발견 |  |
...
| 173 | `dc6ec0` | `None` | SmallActionAroundHide::get_input | 미발견 |  |
| 174 | `cc9740` | `eabbb0` | EpicPokeSubPlan::action_candidates_old | 변경(mig060: 소폭) |  |
| 175 | `e80070` | `f63a10` | SerpenPokeSubPlan::action_candidates_old | 동치(mig060_same 확정: 이동만) |  |
| 176 | `cce210` | `fd98c0` | SmallActionTrace::get_input | ⚠변경·부분규명(전담)(r20) | 전담 · v2 우물 회피/lethal PathFinder 정책(trace_avoid_well·_lethal) · se |
...
| 181 | `d5bbf0` | `f77820` | calculate_interaction_action_score | ⚠변경·부분규명(전담)(r20) | 전담 · v3 분기 5지점(도달가능 산식 · bb 슬롯 스캔 · +0x49c 게이트 8번째 인자 · 꼬리 집계) —  |
...
| 186 | `d59940` | `f749a0` | calculate_action_score | ❗대폭(티어1 이관)(r20) |  |
...
| 191 | `cb03b0` | `e96780` | EpicCheckSubPlan::action_candidates | ❗대폭(티어1 이관)(r20) |  |
...
| 193 | `cc4260` | `eafb50` | JungleSubPlan::action_candidates | 심층(티어1) |  |
| 194 | `cb7540` | `f356b0` | HideSubPlan::action_candidates | 심층(티어1) |  |
...
| 202 | `db9430` | `faa7c0` | LineGankerPlan::next_plan | 심층(티어1) |  |
| 203 | `d2f180` | `fa47a0` | PassiveJunglePlan::next_plan | 심층(티어1) |  |
| 204 | `d8eff0` | `1000320` | calculate_score_parameter | ✅동치(r20) |  |
| 205 | `e65b10` | `d6c2b0` | LegacyPlanHandler::get_small_action | 심층(티어1) |  |
...
| 211 | `eba9b0` | `edb240` | fight_check::check_kill_die_tick_uncache | 심층(티어1) | 심층 · v2 = 구 본체 + bool 게이트(simple/ignore_nuke/no_noise) · **v3 = 신 |
...
| 235 | `e83080` | `f66a30` | AttackNexusSubPlan::score | 변경(mig060: 소폭) |  |
...
| 256 | `e49a50` | `None` | LegacyPlanHandler::update_on_dead | 미발견 |  |
...
| 260 | `e0b030` | `None` | resolve_fight_stake_roster | 미발견 |  |
| 261 | `cd5ee0` | `ebab70` | kite_reposition_point | 동치(mig060_same 확정: 동일) |  |
| 262 | `e25030` | `None` | SmallActionLaneMinionPosition::target_sc | 미발견 |  |
| 263 | `ca6700` | `None` | get_small_action_score_closure | 미발견 |  |
...
| 266 | `dd9f30` | `None` | TeamPlan::can_near_enemies_range | 미발견 |  |
