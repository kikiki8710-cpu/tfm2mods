...
대상 = mig060_same 147 · 변위 짝 총 658 · 미설명 0(함수 0)
...
| `cc5fc0` | `ea8450` | RecallSubPlan::score | 동치(r19: 동치) | ⚠정렬 불가(미확정) · 블록이동 9 · 콜 | 5 | 0 |  |
...
| `ccbb10` | `f3a070` | LineSafeSubPlan::score | 동치(r19: 동치) | ⚠정렬 불가(미확정) · 블록이동 16 ·  | 10 | 0 |  |
| `cce0c0` | `fd9770` | trace::SmallActionTrace::is_end | 동치(mig060_same 확정: 동일) | ✅오프셋만(Δ0xd0) | 2 | 0 |  |
| `ccf670` | `eb4320` | serpen_action_score | 동치(mig060_same 확정: 오프셋 이 | ⚠소형 즉치 변경(7→6·f4→f5·f4→f | 4 | 0 |  |
...
| `d39ba0` | `de6280` | precompute_champion_powers | 동치(mig060_same 확정: 동일) | ✅오프셋만(Δ0x30·0x20·0xf0) | 20 | 0 |  |
...
| `d405d0` | `e78a10` | base_attacking_minion_uncached | 동치(r19: 동치) | ⚠정렬 불가(미확정) · 블록이동 27 ·  | 4 | 0 |  |
| `d408e0` | `faf060` | is_cleared | 동치(mig060_same 확정: 동일) | ✅오프셋만(Δ0xd0·0x2f0) | 3 | 0 |  |
| `d51fb0` | `dd87b0` | SinglePlanBattle::with_runaway | 동치(mig060_same 확정: 동일) | ✅오프셋만(Δ0x20·0x148·0x17b· | 4 | 0 |  |
| `d5ba80` | `f776b0` | calculate_jungle_action_score | 동치(mig060_same 확정: 동일) | ✅오프셋만(Δ0xd0) · 콜리 주의 1 | 2 | 0 |  |
| `d61330` | `100d990` | check_serpen_hunt | 동치(mig060_same 확정: 동일) | ✅오프셋만(Δ0x208·0x2f0·0xd0· | 20 | 0 |  |
| `d62bb0` | `100f210` | check_serpen_setup | 동치(mig060_same 확정: 동일) | ✅오프셋만(Δ0x20·0xd0·0x2e0·0 | 9 | 0 |  |
...
| `d815e0` | `feefc0` | EntityPositioningCache::new | 동치(mig060_same 확정: 동일) | ✅오프셋만(Δ0x20·0x30·0xd0) | 20 | 0 |  |
...
| `d84db0` | `ff5ec0` | position_eval_at | 동치(mig060_same 확정: 동일) | ✅오프셋만(Δ0x1d08·0xd0) · 콜리 | 3 | 0 |  |
...
| `dc2960` | `ed0400` | SmallActionAroundBush::get_input | 변경(r19: ★로직 변경: path_fin | ⚠정렬 불가(미확정) · 블록이동 24 ·  | 6 | 0 |  |
...
| `dd50e0` | `f0c310` | v27_active_objective_discipline | 동치(mig060_same 확정: 동일) | ✅오프셋만(Δ0x278) | 6 | 0 |  |
...
| `de6ce0` | `fb34e0` | check_epic_setup | 동치(mig060_same 확정: 동일) | ✅오프셋만(Δ0x2f0·0xd0·0x208· | 20 | 0 |  |
...
| `dfb220` | `dd87b0` | BattlePlan::with_runaway | 동치(mig060_same 확정: 동일) | ✅오프셋만(Δ0x20·0x108·0x109· | 4 | 0 |  |
...
| `e23170` | `e5d4e0` | SmallActionPlay::evaluation_position | 동치(r19: 동치(vt 0x60/0x68→ | ⚠정렬 불가(미확정) · 블록이동 28 | 7 | 0 |  |
...
| `e4a780` | `d55830` | v3_assign_anchor | 동치(r19: 동치(LPH 레이아웃)) | ⚠소형 즉치 변경(4→7) | 6 | 0 |  |
| `e4b5d0` | `d582a0` | v3_fall_back_to_passive | 동치(mig060_same 확정: 동일) | ✅오프셋만(Δ0x150·0xa8·0xc38· | 5 | 0 |  |
...
| `e8b200` | `f352d0` | LineDefenseSubPlan::score | 동치(mig060_same 확정: 이동만) | ⚠소형 즉치 변경(7→6) · 블록이동 5  | 10 | 0 |  |
...
| `eb5840` | `eae650` | LineWaitSubPlan::score | 동치(r19: 동치) | ⚠정렬 불가(미확정) · 블록이동 16 ·  | 10 | 0 |  |
...
| `ebc140` | `ede720` | attack_structure_skill_action | 동치(mig060_same 확정: 동일) | ⚠소형 즉치 변경(10→f·11→10) ·  | 6 | 0 |  |
...
| `ec7c90` | `f860e0` | epic_action_score | 동치(mig060_same 확정: 오프셋 이 | ⚠소형 즉치 변경(7→6·f4→f5·f4→f | 4 | 0 |  |
