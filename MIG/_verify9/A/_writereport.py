# -*- coding: utf-8 -*-
u"""배치A 산문 보고서 기록기 (REPORT.md 생성)."""
import io, os
HERE = os.path.dirname(os.path.abspath(__file__))
T = r"""# 9차 배치A — 축 `consts[].src_line`(G12) 남은 8건 가리기
...
"""
io.open(os.path.join(HERE, "REPORT.md"), "w", encoding="utf-8").write(T)
print("REPORT.md %d bytes" % len(T.encode("utf-8")))
