...
FREE_FN = {0, 1, 3, 4, 9, 10, 16, 19} | set(range(21, 33)) | set(range(34, 40)) | {41, 45, 46, 48, 49, 50, 51, 52, 53} | {59, 60, 61, 62, 64, 65, 66, 70, 71, 73} | {78, 79, 81, 82, 84, 85, 87, 90, 92, 93, 94, 95, 96, 98, 99, 101}   # r10 16(09-13 밤) · 실측으로 자유 함수(impl 타입 없음)인 것만 · 59~73 = r9(09-13 저녁) · 21~32·34~39 = r7 잎 · 41·45·46·48~53 = r8 잎(심볼 _RNvNt · 09-13)
