# `line_exists` 전수 진리표 (오라클 실측)

> valid_lines(ctx).contains(line)
...
|---|---|---|---|---|---|---|---|---|---|---|
| `line=Mid` | O | . | . | . | O | O | . | O | O | `L_Mid` [0, 4, 5, 7, 8] |
| `line=Bottom` | O | O | . | O | . | O | . | O | O | `L_Bot` [0, 1, 3, 5, 7, 8] |
| `line=Top` | O | . | O | . | . | . | . | O | O | `L_Top` [0, 2, 7, 8] |
