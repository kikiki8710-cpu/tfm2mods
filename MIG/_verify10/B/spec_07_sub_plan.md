...
| 6 | AbstractGame::vtable | 0x40 | get_game_mode | r | divtable 확인. GameMode(128bit) 반환 — 판별자 0=Moba | 3 |
| 7 | AbstractGame::vtable | 0x1f0 | get_entity_by_id | r | divtable 확인. (id: usize) -> Option<&Entity>(널러블 ptr) | 3 |
