...
| 22 | PendingTraceEvent(힙 원소) | 0xb0 | tick | w | · tcx 정본 대조( `tcxdict` 행별 재조회 MATCH (`_verify6/C/memchk.tsv` i=12 idx=22)) | 3 |
