...
| 2 | default | <game_ai::GoalData as std::default::Default>::default | pub | fn() -> game_ai::GoalData | game-ai\src\goal_data.rs:10 | True | True | 4 | ⚠미확정 — 같은 leaf 후보 988개 중 상위 3개만 실음(IR 범위에 이 호출이 없다 = `logic` 산문에서 긁혔거나 접힘) |
| 3 | default | <game_ai::EpicStance as std::default::Default>::default | pub | fn() -> game_ai::EpicStance | game-ai\src\goal_data.rs:133 | True | True | 4 | ⚠미확정 — 같은 leaf 후보 988개 중 상위 3개만 실음(IR 범위에 이 호출이 없다 = `logic` 산문에서 긁혔거나 접힘) |
| 4 | default | <game_ai::EpicStanceData as std::default::Default>::default | pub | fn() -> game_ai::EpicStanceData | game-ai\src\goal_data.rs:145 | True | True | 4 | ⚠미확정 — 같은 leaf 후보 988개 중 상위 3개만 실음(IR 범위에 이 호출이 없다 = `logic` 산문에서 긁혔거나 접힘) |
| 5 | fountain | game_core::MapDef::fountain | pub | fn(&game_core::MapDef, usize) -> (u64, u64, u64, u64) | game-core\src\simulation\map_def.rs:234 | True | True | 4 | ⚠미확정 — 같은 leaf 후보 1개 중 상위 1개만 실음(IR 범위에 이 호출이 없다 = `logic` 산문에서 긁혔거나 접힘) |
| 6 | is_empty | game_core::PatchSetting::is_empty | pub | fn(&game_core::PatchSetting) -> bool | game-core\src\patch_engine.rs:853 | True | True | 4 | ⚠미확정 — 같은 leaf 후보 3개 중 상위 3개만 실음(IR 범위에 이 호출이 없다 = `logic` 산문에서 긁혔거나 접힘) |
| 7 | is_empty | game_core::ModAiRegistry::is_empty | pub | fn(&game_core::ModAiRegistry) -> bool | game-core\src\mod_ai.rs:15 | True | True | 4 | ⚠미확정 — 같은 leaf 후보 3개 중 상위 3개만 실음(IR 범위에 이 호출이 없다 = `logic` 산문에서 긁혔거나 접힘) |
| 8 | is_empty | game_core::PublicChampionEvidence::is_empty | pub | fn(&game_core::PublicChampionEvidence) -> bool | game-core\src\banpick\public_evidence.rs:96 | True | True | 4 | ⚠미확정 — 같은 leaf 후보 3개 중 상위 3개만 실음(IR 범위에 이 호출이 없다 = `logic` 산문에서 긁혔거나 접힘) |
| 9 | sub_plan | game_ai::plan_legacy::types::BigPlan::sub_plan | pub | fn(&mut game_ai::plan_legacy::types::BigPlan, usize, &mut rand::rngs::std::StdRng, &game_core::PlayerState, &game_core::OperationData, &game_ai::GoalData, &game_ai::plan_legacy::team_plan::TeamPlan, &game_core::PositioningScoreData, &mut game_core::DebugFrameData) -> game_ai::plan_legacy::sub_plan::SubPlan | game-ai\src\plan_legacy\types.rs:230 | False | False | 4 | ⚠미확정 — 같은 leaf 후보 16개 중 상위 3개만 실음(IR 범위에 이 호출이 없다 = `logic` 산문에서 긁혔거나 접힘) |
| 10 | sub_plan | game_ai::plan_legacy::old::BattlePlan::sub_plan | pub | fn(&game_ai::plan_legacy::old::BattlePlan, usize, &mut rand::rngs::std::StdRng, &game_core::PlayerState, &game_core::OperationData, &mut game_core::DebugFrameData) -> game_ai::plan_legacy::sub_plan::SubPlan | game-ai\src\plan_legacy\old\battle.rs:2043 | False | False | 4 | ⚠미확정 — 같은 leaf 후보 16개 중 상위 3개만 실음(IR 범위에 이 호출이 없다 = `logic` 산문에서 긁혔거나 접힘) |
| 11 | sub_plan | game_ai::plan_legacy::old::SinglePlanLine::sub_plan | pub | fn(&game_ai::plan_legacy::old::SinglePlanLine, usize, &mut rand::rngs::std::StdRng, &game_core::PlayerState, &game_core::OperationData, &game_ai::plan_legacy::team_plan::TeamPlan, &mut game_core::DebugFrameData) -> game_ai::plan_legacy::sub_plan::SubPlan | game-ai\src\plan_legacy\old\single_line.rs:84 | False | False | 4 | ⚠미확정 — 같은 leaf 후보 16개 중 상위 3개만 실음(IR 범위에 이 호출이 없다 = `logic` 산문에서 긁혔거나 접힘) |
</details>
