...
# 12차 배치 B 도시에 — 담당 `05`~`09` (게임 0.5.8)
...
```bash
cd /c/tfm2mods/MIG
python -X utf8 dossierfresh.py 12 B      # ← 이것만 돌리면 된다
```
...
|---|---|---|---|---|---|---|---|
| `05` | v50_fold_dive_episode | in:game_ai | 30 | 20 | 7 | 1 | 13 |
| `06` | v2_response_retreat_stance | in:game_ai | 13 | 4 | 5 | 0 | 5 |
| `07` | sub_plan | pub | 29 | 7 | 14 | 1 | 7 |
| `08` | is_end | pub | 22 | 6 | 9 | 0 | 3 |
| `09` | check_favorable_engage_formation | pub | 14 | 9 | 11 | 1 | 1 |
...
| # | 이름 | 파일 |
|---|---|---|
| `05` | v50_fold_dive_episode | `MIG\_verify12\B\spec_05_v50_fold_dive_episode.md` |
| `06` | v2_response_retreat_stance | `MIG\_verify12\B\spec_06_v2_response_retreat_stance.md` |
| `07` | sub_plan | `MIG\_verify12\B\spec_07_sub_plan.md` |
| `08` | is_end | `MIG\_verify12\B\spec_08_is_end.md` |
| `09` | check_favorable_engage_formation | `MIG\_verify12\B\spec_09_check_favorable_engage_formation.md` |
...
(이 배치 몫 미해소 = **0건**. 그래도 §4-b 의 무검사 축은 남아 있다.)
...
```bash
cd /c/tfm2mods/MIG && PYTHONIOENCODING=utf-8 python -X utf8 applypatch.py 12 --only B --dry
```
...
## §6 출력 디렉터리 — **_verify12/B 만 써라**

```
MIG/_verify12/B/patch.json      ← 기계 적용분(필수)
MIG/_verify12/B/REPORT.md       ← 산문 보고서
MIG/_verify12/B/oracle/         ← 오라클 .rs · 출력 로그
```
