...
define hidden { i64, i64 } @_RNvNtNtNtCshdEBA0ozCnw_7game_ai11plan_legacy3old6battle27v30_wave_danger_chase_guard(i64 noundef %0, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) %1, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(1728) %2, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(1728) %3, i64 noundef %4, i64 noundef %5, i1 noundef zeroext %6, i64 noundef %7, i64 noundef %8, i1 noundef zeroext %9, i1 noundef zeroext %10, i1 noundef zeroext %11, ptr noalias noundef writeonly captures(none) dereferenceable(1) %12, ptr noalias noundef writeonly captures(none) dereferenceable(1) %13, ptr noalias noundef writeonly captures(none) dereferenceable(1) %14) unnamed_addr #1 personality ptr @__CxxFrameHandler3 !dbg !56366 {
    #dbg_value(ptr poison, !56431, !DIExpression(DW_OP_LLVM_fragment, 64, 64), !56451)
    #dbg_value(ptr poison, !56431, !DIExpression(DW_OP_LLVM_fragment, 320, 64), !56451)
    #dbg_value(i64 %4, !56376, !DIExpression(), !56453)
