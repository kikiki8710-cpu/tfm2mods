...
pub static SW: [Sw; K] = [
    ...
    // ── 배치 5(09-20 · helpers.rs) ──
    sw!("has_line_defense_threat", 0xe768f0, &[0x55, 0x41, 0x57, 0x41, 0x56, 0x41, 0x54, 0x56, 0x57, 0x53, 0x48, 0x83, 0xec, 0x50], crate::helpers::w_has_line_defense_threat),
];
