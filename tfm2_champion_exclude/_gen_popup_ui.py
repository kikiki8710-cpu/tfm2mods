...
head = r'''champ_excl_popup:color {
  ...
  #filter_bar:empty {
    ...
    #class_dd:color_icon_button { @"asset/base/style/main#tertiary_button"; x: 0px; y: 0px; width: 150px; height: 40px;
      icon: { source: "asset/base/ui/icons/dropdown"; rect: { x: 124; y: 14; w: 12; h: 12; } }
      #label:label { @"asset/base/style/main#label"; ignore_event: true; x: 14px; width: 110px; height: 40px; size: 16; align_y: Center; text: "#asset/base/text/ui?champ_excl.class_all"; }
    }
...
tail = r'''      }
  ...
  #class_list:color {
    visible: false; x: 32px; y: 125px; width: 150px; height: 244px;
    ...
    #class_all:color_icon_button { @"asset/base/style/main#tertiary_button"; width: 150px; height: 40px; text: { text: "#asset/base/text/ui?champ_excl.class_all"; size: 15; align_x: Center; align_y: Center; } }
    #class_melee:color_icon_button { @"asset/base/style/main#tertiary_button"; width: 150px; height: 40px; text: { text: "#asset/base/text/ui?champ_excl.class_melee"; size: 15; align_x: Center; align_y: Center; } }
    #class_range:color_icon_button { @"asset/base/style/main#tertiary_button"; width: 150px; height: 40px; text: { text: "#asset/base/text/ui?champ_excl.class_range"; size: 15; align_x: Center; align_y: Center; } }
    #class_magician:color_icon_button { @"asset/base/style/main#tertiary_button"; width: 150px; height: 40px; text: { text: "#asset/base/text/ui?champ_excl.class_magician"; size: 15; align_x: Center; align_y: Center; } }
    #class_util:color_icon_button { @"asset/base/style/main#tertiary_button"; width: 150px; height: 40px; text: { text: "#asset/base/text/ui?champ_excl.class_util"; size: 15; align_x: Center; align_y: Center; } }
    #class_assassin:color_icon_button { @"asset/base/style/main#tertiary_button"; width: 150px; height: 40px; text: { text: "#asset/base/text/ui?champ_excl.class_assassin"; size: 15; align_x: Center; align_y: Center; } }
  }
}
'''
