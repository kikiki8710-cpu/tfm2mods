...
const LOADER_RVA: usize = 0x336a80; // 에셋 게터 FUN(am, path, len) -> NodeTemplate*
const PARSER_RVA: usize = 0x197b10; // .ui 텍스트 → NodeTemplate
const ALLOC_RVA: usize = 0x2f380b0; // 게임 alloc impl(_, flags, size) -> ptr
