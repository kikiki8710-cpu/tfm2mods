...
const RVA_LEN_LOAD: usize = 0x14e9e84;   // 0.5.6(구0.5.5=0x14d819a). 컨테이너델타(레벨업 0x14d7e10→0x15037c0·BYTE=SAME·함수내 +0x38a)·orig 498b96100d0000 실측 일치(r14 베이스·0xd10 불변). // 레벨업 함수 0x14d7e10 내 (구 0.5.4 0x14ece54 / 0.5.3 0x12c5b44 / 0.5.2 0x22d3fea)
...
//   가드검사 0건, 7B 치환 안전.
const RVA_UI_CMP: usize = 0x8d3b84;      // 0.5.6(구0.5.5=0x95d8b9). 컨테이너 0x955680→0xb43ed0(본문변경·BYTE=DIFF)이라 owner내 유일검색으로 확정·orig 483b88100d0000 실측 일치(rax=GameSetting·0xd10 불변). // UI 함수 0x955680 내 (구 0.5.4 0xa99c29 / 0.5.3 0x95a359 / 0.5.2 0x80ae73)
