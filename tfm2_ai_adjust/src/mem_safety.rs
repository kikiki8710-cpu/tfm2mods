...
const TEXT_END_RVA: usize = 0x30a61ff;   // ★0.5.3(was 0.5.2 0x2c087ff). PE .text va=0x1000 vsz=0x30a5200 → vsz_end=0x30a6200 실측(capstone/pefile 2026-07-29). ⚠구값을 두면 .text 후반 40% 게터가 전부 "범위밖"으로 차단돼 재현이 조용히 기본값으로 퇴화한다.
