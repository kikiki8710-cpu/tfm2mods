// ⚠⚠ STALE — 이력용 보존 파일(게임 0.5.5 전용). **현행 = `rva_056.rs`**(2026-08-20 0.5.6 마이그로 include 전환·이 파일은 참조 없음).
//    이 파일의 주소를 현행으로 쓰지 말 것. 0.5.6 값·재핀 근거 = rva_056.rs 헤더 + MIGRATION §7.6 §3 tfm2_ai_adjust 절.
