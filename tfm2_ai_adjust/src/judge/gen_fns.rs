...
//   게임 0.5.8 · exe sha 4ed3aed08971efd0 · 2026-09-06 00:52
...
pub const STEAL_SCORE: FnSpec = FnSpec { name: "steal_score", sym: r"game-ai\src\plan_legacy\sub_plan\steal.rs", role: "scorer", rva: 0xcbbca0, size: 269, prolog: &[0x56, 0x48, 0x83, 0xec, 0x20, 0x48, 0x8b, 0x54, 0x24, 0x58, 0x0f, 0xb6, 0x41, 0x08], status: "todo" };   // 원본 행 27,28 · 70명령 · vslots 0x40,0x1f0
