...
pub(crate) static MICRO_SITES: &[MicroSite] = &[
   ...
   // 근거 = 같은 RE 문서 §A.
    // ★[0.5.8 재핀 2026-09-02] **11건 전부 owner 0xcbbdb0 안**으로 확정.
    //   근거 = 그 함수 안 패턴 개수가 r15×5·rdi×1·r14×1·rsi×4 로 아래 주석과 완전 일치,
    //   그룹 내 간격 0x88 보존, 대응 자리 7B 패턴+imm(120) 일치.
    //   R15 그룹 +2 / RSI 그룹 +6 / 구 0xd3c62b→0xcc0acf / 구 0x13eacf7→0xcc0a2b.
    //   근거 = 그룹 내 간격 0x88 완전 보존 + 대응 자리의 7B 패턴·imm(120) 일치.
    // r15 ×5
    bt_vis!(0xcbce46, &[0x49,0x83,0xc7,0x78,0x49,0x39,0xc7], reg::R15, &[0x49,0x39,0xc7]),
    bt_vis!(0xcbfe7f, &[0x49,0x83,0xc7,0x78,0x49,0x39,0xc7], reg::R15, &[0x49,0x39,0xc7]),
    bt_vis!(0xcbff07, &[0x49,0x83,0xc7,0x78,0x49,0x39,0xc7], reg::R15, &[0x49,0x39,0xc7]),
    bt_vis!(0xcbff8f, &[0x49,0x83,0xc7,0x78,0x49,0x39,0xc7], reg::R15, &[0x49,0x39,0xc7]),
    bt_vis!(0xcc0acf, &[0x49,0x83,0xc7,0x78,0x49,0x39,0xc7], reg::R15, &[0x49,0x39,0xc7]),
    ...
    // rsi ×4
    bt_vis!(0xcbf515, &[0x48,0x83,0xc6,0x78,0x48,0x39,0xc6], reg::RSI, &[0x48,0x39,0xc6]),
    bt_vis!(0xcbf59d, &[0x48,0x83,0xc6,0x78,0x48,0x39,0xc6], reg::RSI, &[0x48,0x39,0xc6]),
    bt_vis!(0xcbf625, &[0x48,0x83,0xc6,0x78,0x48,0x39,0xc6], reg::RSI, &[0x48,0x39,0xc6]),
    bt_vis!(0xcc0a2b, &[0x48,0x83,0xc6,0x78,0x48,0x39,0xc6], reg::RSI, &[0x48,0x39,0xc6]),
];
