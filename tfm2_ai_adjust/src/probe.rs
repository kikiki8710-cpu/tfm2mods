...
//   H1 `0xc975d1`(14B) hide: 적이 나를 **봄** 경로
//   H2 `0xc976a3`(15B) hide: **안 봄 → 부쉬로** 경로  (+ `out_line` 값 히스토)
//   H3 `0xc96ffa`(14B) hide: 부쉬가 100,000보다 **멀다 → 제안 유지** 경로
//   H4 `0xe1ff3f`(12B) 자리선택 밴드: 판단력 원시값 `[rbp+0x290]`
...
//   ⛔결함1: `0xc96ffa`와 `0xc976a3`을 같은 모집단으로 보고 비율을 냈다(215%가 나왔다).
