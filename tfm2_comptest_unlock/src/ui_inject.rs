...
const LOADER_RVA: usize = 0x337930; // 0.5.6 재핀        // ★0.5.5(구0.5.4=0x2e35d0) 문자열-xref 31표(§7.5)·프롤로그 바이트동일·함수경계 유효 // 0.5.4(구0.5.3=0x2e1550)
const PARSER_RVA: usize = 0x1a5a70; // 0.5.6 재핀        // ★0.5.5(구0.5.4=0x1a3ce0) skeleton UNIQUE·크기 2192B 동일 // 0.5.4(구0.5.3=0x1a6530) 3인자 계약·노드 stride 0x90 유지
...
const ALLOC_RVA: usize = 0x2f64f90; // 0.5.6 재핀        // ★0.5.5(구0.5.4=0x29bb920) skeleton UNIQUE·60B 동일 // 0.5.4(구0.5.3=0x28f7df0) HeapAlloc 래퍼
