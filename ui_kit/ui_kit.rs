...
const DD_SETOPT_RVA:  usize = 0x1e7ba0;   // ★★0.5.7 재핀(2026-08-27): match_fn UNIQUE, 프롤로그 24B 완전동일. 0.5.6=0x1c1710. ⚠ui_kit 은 공유모듈이라 모드별 스캔에서 누락되기 쉬운데, 이게 어긋나면 드롭다운을 여는 순간 **panic도 예외도 없이 즉사**한다(0.5.7 champ_pos_lock 포지션제한 팝업 크래시 실사고).  // (rcx=runner, rdx=sel, r8=&[cap,ptr,len])
